...
#### Inspiration
As a doctor working in the Polonnaruwa district of Sri Lanka, I have observed that the prevalence of CKD in this area is alarmingly high. Which is often obsered through various reaseach. (https://doaj.org/article/9e1d2d9528464fcea616fe02c845841b)  
...
### Trained model
best model among the trained models was a Random Forrest Classifier model. You can find more information regarding the steps of the model training on this Jupyter Notebook.
