...
Please refer to the [Jupyter Notebook](https://github.com/Pra4v3/ckd_prediction/blob/main/ckd_project.ipynb) for detailed clarifications.

### Trained model
The best model among the trained models was a Random Forest Classifier. More information regarding the steps of the model training can be found in this [Jupyter Notebook.](https://github.com/Pra4v3/ckd_prediction/blob/main/ckd_project.ipynb)
